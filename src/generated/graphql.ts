...
export type QueryVehicleOrComponentByCodeArgs = {
  code: Scalars['String'];
};
...
export type Mutation = {
  __typename?: 'Mutation';
  createComponentScan: MutationPayloadOfComponentScan;
...
export type MutationCreateComponentScanArgs = {
  input: ComponentScanInput;
};
...
export type ComponentFilter = {
  ...
  createdAt_not_lte?: Maybe<Scalars['DateTime']>;
  iconUURL?: Maybe<Scalars['String']>;
  iconUURL_contains?: Maybe<Scalars['String']>;
  iconUURL_ends_with?: Maybe<Scalars['String']>;
  iconUURL_in?: Maybe<Array<Maybe<Scalars['String']>>>;
  iconUURL_not?: Maybe<Scalars['String']>;
  iconUURL_not_contains?: Maybe<Scalars['String']>;
  iconUURL_not_ends_with?: Maybe<Scalars['String']>;
  iconUURL_not_in?: Maybe<Array<Maybe<Scalars['String']>>>;
  iconUURL_not_starts_with?: Maybe<Scalars['String']>;
  iconUURL_starts_with?: Maybe<Scalars['String']>;
  id?: Maybe<Scalars['Uuid']>;
  id_gt?: Maybe<Scalars['Uuid']>;
  id_gte?: Maybe<Scalars['Uuid']>;
  id_in?: Maybe<Array<Scalars['Uuid']>>;
...
export type ComponentSort = {
  ...
  iconUURL?: Maybe<SortOperationKind>;
...
export type VehicleOrComponentDto = {
  __typename?: 'VehicleOrComponentDTO';
  code: Scalars['String'];
  component?: Maybe<Component>;
  vehicle?: Maybe<Vehicle>;
};
...
export type ComponentScanInput = {
  scan1: Scalars['String'];
  scan2: Scalars['String'];
  vehicleComponentId: Scalars['Uuid'];
};
...
export type MutationPayloadOfComponentScan = {
  __typename?: 'MutationPayloadOfComponentScan';
  entity?: Maybe<ComponentScan>;
  errors: Array<Error>;
};
